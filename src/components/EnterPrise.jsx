...
const forthdiv = [
  ...
  },
  {
    ...
    desc: "Great video content speaks louder than words (literally), and doesn’t need to be made from scratch. Clipnex Visuals makes it easy to repurpose all of your existing marketing assets and messaging into captivating bite-sized videos optimized for online distribution. Multiply the content you already have and work smarter, not harder.",
  },
  {
    title: "Increase your customer engagement frequency",
    desc: "The most engaging brands are consistent and frequent with their communication while sharing relevant content that capture their audiences eyes, minds, and hearts. With Clipnex Visuals, your team can produce engaging videos in minutes, allowing your brand to stay top-of-mind, up-to-date, and relevant.",
  },
  {
    title: "Complement your agency with Clipnex Visuals",
    desc: "Not every video needs a big budget. While agencies are great for your mega high-production campaigns, such as TV commercials, brands are turning to Clipnex Visuals to meet the demands of daily or weekly video content, purpose-built for social media and corporate communications.",
  },
];
const eightdiv=[
  {title:"Siemens",
   desc:"“One of the goals of the company is to help our customers in their digital transformation, Clipnex Visuals helps us in getting more digital in our communications—that’s part of the digital transformation.”",
  ...
  {title:"Mitsubishi",
  desc:"“Thanks to Clipnex Visuals, we have been able to cut down on time and costs for video making. We don’t have to go through a third party which speeds everything up and makes our work a lot easier.”",
 ...
 {title:"Cisco",
 desc:"“At Cisco we try to share lots of multimedia content and new types of content like memes, graphics and videos. And the videos by far give us the most engagement, thanks to Clipnex Visuals.”",
    ...
    <>
      ...
      <div className="en-div1">
        <div className="en-div1-mainpara">
          ...
          <div className="en-div1-para">
            <h3>
              Clipnex Visuals is the easiest and fastest way to create videos with your
      ...
      <div className="en-div-5-cont">
        ...
        <div className="en-div5-desc">
          ...
          <div className="en-div5-para">
            <h3>
              Clipnex Visuals is an unbelievably easy to use video creator built
              ...
              six minutes in Clipnex Visuals. </h3>
              <h3>
      ...
      <section className="en-div9-main">
                <h1 className="en-div9-head">Explore videos make with Clipnex Visuals</h1>
            ...
            <section className="en-div11-main">
               ...
               boost engagement with Clipnex Visuals</div>
